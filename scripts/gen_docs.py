  ...
  content = wrap_in_html('''
    <div class="markdown-body">
      <div class="text-section">
        ...
        <h3>Legacy images</h3>
        <p>As of Mar 2025, this project is up-to-date with Gen 9. All old images from Gen 7 (Pokémon Ultra Sun/Ultra Moon) are still available for legacy support.</p>
